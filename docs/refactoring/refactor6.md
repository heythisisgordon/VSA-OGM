...
4. Shannon entropy feature extraction (Phase 4)
5. Main interface and CLI updates (Phase 5 - Current)
...
### New Utility Functions for Entropy Visualization

Add these functions to `src/utils.py`:
